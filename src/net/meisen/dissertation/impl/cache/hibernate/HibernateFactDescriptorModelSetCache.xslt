...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                              ...
                              xmlns:hibernate="http://dev.meisen.net/xsd/dissertation/caches/facts/hibernate">

  <xsl:template match="hibernate:config">
    <bean class="net.meisen.dissertation.impl.cache.hibernate.HibernateFactDescriptorModelSetCacheConfig">
