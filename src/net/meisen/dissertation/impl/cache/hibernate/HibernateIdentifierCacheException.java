 ...
 * 
 */
public class HibernateIdentifierCacheException extends RuntimeException {
	 ...
	 */
	public HibernateIdentifierCacheException(final String message) {
		super(message);
	}
	 ...
	 */
	public HibernateIdentifierCacheException(final String message, final Throwable t) {
		super(message, t);
	}
}
