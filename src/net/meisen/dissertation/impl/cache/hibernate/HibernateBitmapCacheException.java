 ...
 * 
 */
public class HibernateBitmapCacheException extends RuntimeException {
	 ...
	 */
	public HibernateBitmapCacheException(final String message) {
		super(message);
	}
	 ...
	 */
	public HibernateBitmapCacheException(final String message, final Throwable t) {
		super(message, t);
	}
}
